		...
		<section id="first_post_section">
			...
			<div className="post_detail">
				...
				<div className="share_container">
					<FacebookShareButton url={path_name} quote={r_name} className="share_button">
						<FacebookIcon size={32} round={true} />
					</FacebookShareButton>

					<TwitterShareButton url={path_name} quote={r_name} className="share_button">
						<TwitterIcon size={32} round={true} />
					</TwitterShareButton>

					<WhatsappShareButton url={path_name} quote={r_name} className="share_button">
